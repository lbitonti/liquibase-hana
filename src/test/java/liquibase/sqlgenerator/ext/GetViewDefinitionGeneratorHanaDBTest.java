...
public class GetViewDefinitionGeneratorHanaDBTest extends AbstractSqlGeneratorHanaDBTest<GetViewDefinitionStatement> {
	...
	protected GetViewDefinitionStatement createSampleSqlStatement() {
        ...
        GetViewDefinitionStatement getViewDefinitionStatement = new GetViewDefinitionStatement(null, "view_name");
    ...
    public void testGetViewNoSchema() {
        Database database = new HanaDBDatabase();
        GetViewDefinitionStatement statement = new GetViewDefinitionStatement(null, "actual_view_name");
    ...
    public void testGetViewWithSchema() {
        Database database = new HanaDBDatabase();
        GetViewDefinitionStatement statement = new GetViewDefinitionStatement("schema_name", "actual_view_name");
