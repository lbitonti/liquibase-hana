...
public class RenameTableGeneratorHanaDBTest extends AbstractSqlGeneratorHanaDBTest<RenameTableStatement> {
	...
	protected RenameTableStatement createSampleSqlStatement() {
        ...
        RenameTableStatement renameTableStatement = new RenameTableStatement(null, "old_table_name", "new_table_name");
    ...
    public void testRenameTableNoSchema() {
        Database database = new HanaDBDatabase();
        RenameTableStatement statement = new RenameTableStatement(null, "old_table_name", "new_table_name");
    ...
    public void testRenameTableWithSchema() {
        Database database = new HanaDBDatabase();
        RenameTableStatement statement = new RenameTableStatement("schema_name", "old_table_name", "new_table_name");
